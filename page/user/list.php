    ...
    {  
            while($rowUser=mysqli_fetch_array($queryAdmin))
            {
                echo "<tr>
                        ...
                        <td class='tengah'><a class='tombol-action' href='admin.php?page=user&action=form&user_id=$rowUser[user_id]"."'>Edit</a></td>
                        <td class='tengah'><a class='tombol-action' href='admin.php?page=user&action=hapus&user_id=$rowUser[user_id]"."'>Hapus</a></td>
                     </tr>";
